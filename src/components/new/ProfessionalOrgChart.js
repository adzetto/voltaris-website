    ...
    return (
      ...
      >
        ...
        <div className="text-center">
          <p className={`text-sm text-white ${isExpanded ? 'font-bold' : ''}`}>{member.name}</p>
  ...
  return (
    <div className="w-full bg-black/30 backdrop-blur-sm p-6 rounded-lg border border-gray-800 shadow-xl">
      ...
      <div className="org-chart">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="flex justify-center">
            <div 
              className={`org-box board-box cursor-pointer ${isMemberExpanded(teamData.advisors[0]?.id) ? 'border-blue-500/50' : ''}`}
              onClick={(e) => toggleMember(teamData.advisors[0]?.id, e)}
            >
              <div className="flex items-center justify-center mb-2">
                <div className={`${isMemberExpanded(teamData.advisors[0]?.id) ? 'w-32 h-32' : 'w-28 h-28'} rounded-lg overflow-hidden border-2 border-blue-500/30 mx-auto shadow-lg shadow-blue-500/10 transition-all duration-300`}>
                  <img 
              ...
              <div className="text-center">
                <h4 className="font-bold text-white">Akademik Danışman</h4>
                <p className="text-sm text-blue-400">{teamData.advisors[0]?.name || "Prof. Dr. Erdal Çetkin"}</p>
          ...
          <div className="flex justify-center">
            <div 
              className={`org-box ceo-box cursor-pointer ${isMemberExpanded(teamData.teamLeadership[0]?.id) ? 'border-red-500/50' : ''}`}
              onClick={(e) => toggleMember(teamData.teamLeadership[0]?.id, e)}
            >
              <div className="flex items-center justify-center mb-2">
                <div className={`${isMemberExpanded(teamData.teamLeadership[0]?.id) ? 'w-32 h-32' : 'w-28 h-28'} rounded-lg overflow-hidden border-2 border-red-500/30 mx-auto shadow-lg shadow-red-500/10 transition-all duration-300`}>
                  <img 
              ...
              <div className="text-center">
                <h4 className="font-bold text-white">{teamData.teamLeadership[0]?.name || "Ömer Ünal"}</h4>
                <p className="text-sm text-red-400">Takım Kaptanı</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center">
            <div 
              className={`org-box director-box cursor-pointer transition-all duration-300 ${isSectionExpanded('electronics') ? 'border-red-500/50 shadow-lg shadow-red-900/10' : 'hover:border-red-500/30'} ${isMemberExpanded(teamData.electronicsTeam.captain?.id) ? 'border-red-500/50' : ''}`}
              onClick={(e) => toggleMember(teamData.electronicsTeam.captain?.id, e)}
            >
              <div className="flex items-center justify-center mb-2">
                <div className={`${isMemberExpanded(teamData.electronicsTeam.captain?.id) ? 'w-32 h-32' : 'w-28 h-28'} rounded-lg overflow-hidden border-2 border-red-500/30 mx-auto shadow-lg shadow-red-500/10 transition-all duration-300`}>
                  <img 
                    src={teamData.electronicsTeam.captain?.image || "/team/placeholder-3.jpg"}
              ...
              <div className="text-center">
                <h4 className="font-bold text-white">{teamData.electronicsTeam.captain?.name}</h4>
                <p className="text-sm text-red-400">Elektrik Elektronik Birimi Lideri</p>
            ...
            {/* Unit Info Button */}
            <button 
            className="mt-2 flex items-center justify-center text-xs text-blue-500 hover:text-blue-300 bg-blue-900/20 px-3 py-1 rounded shadow-sm transition-all hover:shadow-md"
            ...
            {isUnitInfoOpen('electronics') && (
              <div className="unit-info-box mt-4 w-full max-w-sm bg-black/70 border border-blue-500/20 rounded-lg p-4 animate-fadeIn shadow-lg" style={{
                ...
                <h5 className="font-bold text-blue-400 mb-2">{unitInfoData.electronics.title}</h5>
                <p className="text-sm text-gray-300 mb-3">{unitInfoData.electronics.description}</p>
          ...
          <div className="flex flex-col items-center">
            <div 
              className={`org-box director-box cursor-pointer transition-all duration-300 ${isSectionExpanded('mechanical') ? 'border-green-500/50 shadow-lg shadow-green-900/10' : 'hover:border-green-500/30'} ${isMemberExpanded(teamData.mechanicalTeam.captain?.id) ? 'border-green-500/50' : ''}`}
              onClick={(e) => toggleMember(teamData.mechanicalTeam.captain?.id, e)}
            >
              <div className="flex items-center justify-center mb-2">
                <div className={`${isMemberExpanded(teamData.mechanicalTeam.captain?.id) ? 'w-32 h-32' : 'w-28 h-28'} rounded-lg overflow-hidden border-2 border-green-500/30 mx-auto shadow-lg shadow-green-500/10 transition-all duration-300`}>
                  <img 
                    src={teamData.mechanicalTeam.captain?.image || "/team/placeholder-13.jpg"}
              ...
              <div className="text-center">
                <h4 className="font-bold text-white">{teamData.mechanicalTeam.captain?.name}</h4>
                <p className="text-sm text-green-400">Mekanik Birimi Lideri</p>
                  ...
                  <div className="mt-2 flex justify-center space-x-2">
                    {teamData.mechanicalTeam.captain.email && (
                      <a 
                        ...
                        className="p-2 bg-green-900/20 text-green-400 rounded-full hover:bg-green-900/40 transition-colors"
                        onClick={(e) => e.stopPropagation()}
            ...
            {isUnitInfoOpen('mechanical') && (
              <div className="unit-info-box mt-4 w-full max-w-sm bg-black/70 border border-green-500/20 rounded-lg p-4 animate-fadeIn">
                <h5 className="font-bold text-green-400 mb-2">{unitInfoData.mechanical.title}</h5>
                <p className="text-sm text-gray-300 mb-3">{unitInfoData.mechanical.description}</p>
          ...
          <div className="electronics-expanded mb-12 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex justify-center">
                  <button 
                    className="mt-2 flex items-center justify-center text-xs text-red-400 hover:text-red-300 bg-red-900/10 px-3 py-1 rounded-full"
                ...
                {isUnitInfoOpen('vehicleControl') && (
                  <div className="unit-info-box mt-4 w-full bg-black/70 border border-red-500/20 rounded-lg p-4 animate-fadeIn">
                    <h5 className="font-bold text-red-400 mb-2">{unitInfoData.vehicleControl.title}</h5>
                    <p className="text-sm text-gray-300 mb-3">{unitInfoData.vehicleControl.description}</p>
                    <div className="bg-red-900/10 rounded-lg p-3">
                      <h6 className="text-xs text-red-400 font-medium mb-2">Çalışma Alanları:</h6>
                      <ul className="text-xs text-gray-400">
              ...
              <div className="flex flex-col">
                ...
                {isUnitInfoOpen('embeddedSoftware') && (
                  <div className="unit-info-box mt-4 w-full bg-black/70 border border-red-500/20 rounded-lg p-4 animate-fadeIn">
                    <h5 className="font-bold text-red-400 mb-2">{unitInfoData.embeddedSoftware.title}</h5>
                    <p className="text-sm text-gray-300 mb-3">{unitInfoData.embeddedSoftware.description}</p>
                    <div className="bg-red-900/10 rounded-lg p-3">
                      <h6 className="text-xs text-red-400 font-medium mb-2">Çalışma Alanları:</h6>
                      <ul className="text-xs text-gray-400">
              ...
              <div className="flex flex-col">
                ...
                {isUnitInfoOpen('batteryBMS') && (
                  <div className="unit-info-box mt-4 w-full bg-black/70 border border-red-500/20 rounded-lg p-4 animate-fadeIn">
                    <h5 className="font-bold text-red-400 mb-2">{unitInfoData.batteryBMS.title}</h5>
                    <p className="text-sm text-gray-300 mb-3">{unitInfoData.batteryBMS.description}</p>
                    <div className="bg-red-900/10 rounded-lg p-3">
                      <h6 className="text-xs text-red-400 font-medium mb-2">Çalışma Alanları:</h6>
                      <ul className="text-xs text-gray-400">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col">
                ...
                {isUnitInfoOpen('chassis') && (
                  <div className="unit-info-box mt-4 w-full bg-black/70 border border-green-500/20 rounded-lg p-4 animate-fadeIn">
                    <h5 className="font-bold text-green-400 mb-2">{unitInfoData.chassis.title}</h5>
                    <p className="text-sm text-gray-300 mb-3">{unitInfoData.chassis.description}</p>
                    <div className="bg-green-900/10 rounded-lg p-3">
                      <h6 className="text-xs text-green-400 font-medium mb-2">Çalışma Alanları:</h6>
                      <ul className="text-xs text-gray-400">
              ...
              <div className="flex flex-col">
                ...
                {isUnitInfoOpen('shell') && (
                  <div className="unit-info-box mt-4 w-full bg-black/70 border border-green-500/20 rounded-lg p-4 animate-fadeIn">
                    <h5 className="font-bold text-green-400 mb-2">{unitInfoData.shell.title}</h5>
                    <p className="text-sm text-gray-300 mb-3">{unitInfoData.shell.description}</p>
                    <div className="bg-green-900/10 rounded-lg p-3">
                      <h6 className="text-xs text-green-400 font-medium mb-2">Çalışma Alanları:</h6>
                      <ul className="text-xs text-gray-400">
      ...
      <style jsx>{`
        ...
        .board-box {
          background: linear-gradient(to bottom, rgba(30, 64, 175, 0.2), rgba(0, 0, 0, 0.7));
        ...
        .horizontal-connector-wide {
          ...
          width: 80%;
          height: 2px;
          background: linear-gradient(to right, rgba(59, 130, 246, 0.5), rgba(30, 64, 175, 0.3));
          margin-left: auto;
          margin-right: auto;
        }
        ...
        .horizontal-connector-wide::after {
          ...
          box-shadow: 0 -4px 0 rgb(59, 130, 246, 0.5);
        }
