...
const EnhancedSponsorsBar = ({ sponsors }) => {
  ...
  return (
    <div className="relative w-full bg-black border-t border-gray-800/30 pt-4 pb-8 sponsor-bar">
      {/* Header section */}
      <div className="flex items-center justify-between px-6 mb-4">
        <div className="flex items-center">
          ...
          <div className="ml-2 h-px w-8 bg-gradient-to-r from-gray-500/40 to-transparent"></div>
        </div>
        
        <div className="flex items-center">
          <span className="px-1.5 py-0.5 border border-gray-800/50 rounded bg-black/30 hover:border-gray-700/50 transition-colors">
            <a 
              href="#sponsors" 
              className="text-gray-500 hover:text-gray-300 flex items-center text-[9px] uppercase" 
